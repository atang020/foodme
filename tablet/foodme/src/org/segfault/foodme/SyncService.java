...
// Triggers the SyncAdapter from the Android sync framework
public class SyncService extends Service{
	...
	public void onCreate() {
		super.onCreate();
		//Create the sync adapter as a singleton.  Set the sync adapter 
		//as syncable.  Disallow parallel syncs.
